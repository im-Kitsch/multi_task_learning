...
df = pd.read_csv(f"{DATA_PATH}/pflow_mini_original.csv", header=None, nrows=5000)
...
move_modes = np.zeros((n_samples, traj_n_samples))
...
for i in range(n_samples):
    ...
    sub_move_md = sub_df.loc[:, 13].to_numpy()
    move_modes[i] = sub_move_md
