...
rnn_net = RnnNet(one_hot_dim, HID_SIZE, [share_gru1, share_gru2])

optimizer = torch.optim.Adam(rnn_net.parameters(), lr=1e-3)

data_sampler.sample(15, 5)
...
for _i in range(1000):
    ...
    writer.add_scalar("loss", loss, _i)
    print(f"step {_i}, loss {loss}")
